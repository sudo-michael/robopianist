...
def make_env(song: str = 'TwinkleTwinkleRousseau', 
    ...
    def _init():
        ...
        env = DMCGYM(env)
        env = shimmy.GymV21CompatibilityV0(env=env)  # convert to gymnasium format
...
if __name__ == '__main__':
    env = make_env('TwinkleTwinkleRousseau', 0, False)()  # gymnasium form
    # print(env.action_space)

    env = safety_gymnasium.wrappers.Gymnasium2SafetyGymnasium(env) # safety-gymnasium form
    obs, info = env.reset()
    print(env.action_space)

    # tmp_path = "./logs/safety/ppo/"
    # # set up logger
