...
if __name__ == '__main__':
    ...
    # setup logger1
    tmp_path1 = f"./logs/cl/cl0/{song1}{timestep1}"
    tmp_path2 = f"./logs/cl/cl0/{song2}{timestep2}"
    ...
    model1.save(f'models/cl/cl0/m1_{song1}_{timestep1}')
    print("The training of model1 is finished.")

    del model1

    env2 = make_env_cl(song2, 0, False, timestep=timestep2)()
    model2 = DroQ.load(f'models/cl/cl0/m1_{song1}_{timestep1}', env=env2)  # the load environment is not sure
    ...
    model2.save(f'models/cl/cl0/m2_{song2}_{timestep2}')
